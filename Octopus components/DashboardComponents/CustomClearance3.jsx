...
class CustomClearance3 extends React.Component{
    constructor(props){
        super(props);
                ...
                <div style={headingStyle} className='bg bg-info ml-4 mr-4 mt-2 mb-4'>
                    <div className='row'>
                        <div style={texts} className='col-12 bg bg-secondary'>
                            <h4 className='p-2 float-left'>Import Custom Clearance (Page 3/3)</h4>
                        </div>
                    </div>
...
export default CustomClearance3;